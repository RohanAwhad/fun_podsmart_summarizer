...
# res = gpt_3_5._generate(inputs, verbose=True)
# print(parse_title_summary_results(gpt_3_5.get_text_from_response(res)))
# exit(0)
...
with open('gpt_3_5_summary_1_stage_1.txt', 'w') as f:
...
with open('gpt_3_5_summary_1_stage_1.json', 'w') as f:
